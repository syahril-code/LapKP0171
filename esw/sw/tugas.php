				...
				$tku = mysqli_num_rows($qku);
              	...
              	if (!empty($tku))
              		...
              		do
						...
						$yuk_nilai = balikin($ryuk['nilai']);
						$yuk_nilai_ket = balikin($ryuk['nilai_ket']);
						$yuk_nilai_postdate = balikin($ryuk['nilai_postdate']);
						...
						if (empty($tyuk))
							{
							echo '<p>						
							<a href="tugas_kerjakan.php?gmkd='.$gmkd.'&jkd='.$u_jkd.'" class="btn btn-danger">KUMPULKAN TUGAS >></a>
							</p>';
							}
						else
							{
							...
							if (empty($yuk_nilai))
								{
								echo '<p>
								<i>Tugas Dikumpulkan pada : '.$yuk_postdate.'.</i>
								<br>
								<b>
								<font color="red">Tugas Masih Diperiksa Guru.</font>
								</b>
								</p>';
								}		
								...
								<p>
								Postdate : <b>'.$yuk_nilai_postdate.'</i>
								</p>
					...
					{
					echo '<h3>
					<font color="red">BELUM ADA TUGAS..</font>
					</h3>';
					}
